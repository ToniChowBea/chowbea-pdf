...
import type {
  ...
  Rotate_pdf_rotate_postBody,
  Rotate_pdf_rotate_postResponse,
...
export const createOperations = (apiClient: ApiClient) => ({
   ...
   * 
   * @operationId rotate_pdf_rotate_post
   * @method POST
   * @path /pdf/rotate
   */
  rotate_pdf_rotate_post: (data: Rotate_pdf_rotate_postBody, config?: AxiosRequestConfig): Promise<Result<Rotate_pdf_rotate_postResponse>> => apiClient.post("/pdf/rotate", data, config),
